...
- 발표 자료 삭제 / 복제 / 휴지통 — 삭제·휴지통은 Phase 2 (2026-05-21) 에서 진입, 복제는 여전히 밖
- 되돌리기 기록 (history / rollback)
- 내보내기 센터 (PDF/PPTX/Figma export) — Phase 1 마지막에 통합 (2026-05-18)
- 회사 디자인 / 브랜드 규칙 / 정책 설정 — Phase 2 "내 양식 v1" (2026-05-25) 에서 brand kit (로고·색·폰트) 부분 진입. archetype 갤러리는 v2, AI 새 모양 만들기는 v3
- outline 별도 단계, "발표 자료가 만들어지기 전에 목차 확인" — Phase 1 마지막에 통합 (2026-05-18)
- 멀티 유저 / 클라우드 동기화 / 권한
- 모바일 최적화

이 항목들은 PRD에는 들어있지만 Phase 1 산출물에서는 메뉴/버튼 노출도 하지 않는다 (위 주석 표시된 항목은 Phase 2 이후 들어옴).
